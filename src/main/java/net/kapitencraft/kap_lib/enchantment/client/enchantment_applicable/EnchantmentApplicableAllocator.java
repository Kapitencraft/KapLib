package net.kapitencraft.kap_lib.enchantment.client.enchantment_applicable;
...
public class EnchantmentApplicableAllocator extends FontSet {
    ...
    public static final ResourceLocation FONT = LibConstants.res("enchantment_applicable");
