...
import net.kapitencraft.kap_lib.core.client.menu.widget.drop_down.elements.MultiElementSelectorElement;
...
public class ConfigureOverlaysScreen extends MenuableScreen {
    private final OverlayManager controller = OverlayManager.INSTANCE;
