package net.kapitencraft.kap_lib.overlay.box;

import net.kapitencraft.kap_lib.core.client.menu.MenuableScreen;
...
import net.kapitencraft.kap_lib.core.client.menu.IMenuBuilder;
...
import net.kapitencraft.kap_lib.core.client.menu.widget.drop_down.elements.ButtonElement;
import net.kapitencraft.kap_lib.core.client.menu.widget.drop_down.elements.EnumElement;
...
public class ResizeBox extends InteractiveBox implements IMenuBuilder {
    ...
    private void reset() {
        OverlayManager controller = OverlayManager.INSTANCE;
