package net.kapitencraft.kap_lib.core.client.menu.widget.scroll;

import net.kapitencraft.kap_lib.core.client.UsefulTextures;
import net.kapitencraft.kap_lib.core.client.menu.widget.Menu;
import net.kapitencraft.kap_lib.core.client.menu.widget.scroll.elements.ScrollElement;
...
/**
 * @deprecated move to {@link net.kapitencraft.kap_lib.core.client.menu.widget.drop_down.elements.MultiElementSelectorElement MultiElementSelectorWidget}
 */
@Deprecated
