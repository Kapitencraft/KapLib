...
public class AttributeUtilMixin {
    ...
    private static MutableComponent addAttributeExtensions(Attribute instance, double value, double entityBase, boolean merged, TooltipFlag tooltipFlag, Operation<MutableComponent> original, @Local(argsOnly = true, name = "arg0") ItemStack stack, @Share("base") LocalRef<BaseModifierAccessor> mod) {
