...
public abstract class TextureProvider implements DataProvider {
    ...
    protected void registerOre(ResourceLocation paletteSource, ResourceLocation name) {
        this.register(paletteSource, name.withPrefix("item/raw_"))
                .then(Transfer.create(new ResourceLocation("item/raw_gold")));
        this.register(paletteSource, name.withPrefix("item/").withSuffix("_dust"))
                .then(Transfer.create(new ResourceLocation("item/glowstone_dust")));
    }
    ...
    protected void registerNetheriteArmor(ResourceLocation paletteSource, ResourceLocation name) {
        this.register(paletteSource, name.withPrefix("item/").withSuffix("_helmet"))
                .then(Transfer.create(new ResourceLocation("item/netherite_helmet")));
        this.register(paletteSource, name.withPrefix("item/").withSuffix("_chestplate"))
                .then(Transfer.create(new ResourceLocation("item/netherite_chestplate")));
        this.register(paletteSource, name.withPrefix("item/").withSuffix("_leggings"))
                .then(Transfer.create(new ResourceLocation("item/netherite_leggings")));
        this.register(paletteSource, name.withPrefix("item/").withSuffix("_boots"))
                .then(Transfer.create(new ResourceLocation("item/netherite_boots")));
        this.register(paletteSource, name.withPrefix("models/armor/").withSuffix("_layer_1"))
                .then(Transfer.create(new ResourceLocation("models/armor/netherite_layer_1")));
        this.register(paletteSource, name.withPrefix("models/armor/").withSuffix("_layer_2"))
                .then(Transfer.create(new ResourceLocation("models/armor/netherite_layer_2")));
    }

    protected void registerDiamondArmor(ResourceLocation paletteSource, ResourceLocation name) {
        this.register(paletteSource, name.withPrefix("item/").withSuffix("_helmet"))
                .then(Transfer.create(new ResourceLocation("item/diamond_helmet")));
        this.register(paletteSource, name.withPrefix("item/").withSuffix("_chestplate"))
                .then(Transfer.create(new ResourceLocation("item/diamond_chestplate")));
        this.register(paletteSource, name.withPrefix("item/").withSuffix("_leggings"))
                .then(Transfer.create(new ResourceLocation("item/diamond_leggings")));
        this.register(paletteSource, name.withPrefix("item/").withSuffix("_boots"))
                .then(Transfer.create(new ResourceLocation("item/diamond_boots")));
        this.register(paletteSource, name.withPrefix("models/armor/").withSuffix("_layer_1"))
                .then(Transfer.create(new ResourceLocation("models/armor/diamond_layer_1")));
        this.register(paletteSource, name.withPrefix("models/armor/").withSuffix("_layer_2"))
                .then(Transfer.create(new ResourceLocation("models/armor/diamond_layer_2")));
    }
}