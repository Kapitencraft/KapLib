...
public record Color(float r, float g, float b, float a) {
    ...
    /**
     * returns the median of the 2 colors
     */
    ...
    /**
     * mixes the 2 colors taking in consideration the percentage to use the first vs second one
     */
    ...
    /**
     * write this color to the network
     * <br>devs should use the {@link #STREAM_CODEC} instead
     */
    @ApiStatus.Internal
    ...
    /**
     * reads this color from the network
     * <br>devs should use the {@link #STREAM_CODEC} instead
     */
    ...
    /**
     * converts this color into a TextColor which can be used in chat
     */
