package net.kapitencraft.kap_lib.bonus.datagen;
...
/**
 * data generator for bonuses with inventory page compat
 */
public abstract class WearableBonusProvider extends ItemTagsProvider {
     ...
     */
    public WearableBonusProvider(PackOutput output, String modId, CompletableFuture<HolderLookup.Provider> pLookupProvider, @Nullable ExistingFileHelper existingFileHelper) {
    ...
    protected class SetBuilder extends ItemBuilder {
        ...
        public SetBuilder slot(EquipmentSlot slot, Consumer<SetSlotBuilder> builder) {
            equipmentContent.putIfAbsent(slot, Util.make(new SetSlotBuilder(ResourceLocation.fromNamespaceAndPath(WearableBonusProvider.this.modId, "set/" + name + "/" + slot.getName())), builder));
            return this;
        }
        ...
        public SetBuilder slot(WearableSlot slot, Consumer<SetSlotBuilder> builder) {
            ...
            wearableContent.putIfAbsent(slot, Util.make(new SetSlotBuilder(ResourceLocation.fromNamespaceAndPath(WearableBonusProvider.this.modId, "set/" + name + "/wearable/" + location.getNamespace() + "/" + location.getPath())), builder));
            return this;
        }
        ...
        public SetBuilder slot(Holder<WearableSlot> slot, Consumer<SetSlotBuilder> builder) {
            ...
            wearableContent.putIfAbsent(slot.value(), Util.make(new SetSlotBuilder(ResourceLocation.fromNamespaceAndPath(WearableBonusProvider.this.modId, "set/" + name + "/wearable/" + location.getNamespace() + "/" + location.getPath())), builder));
            return this;
        }
    ...
    protected static class SetSlotBuilder {
         ...
         */
        public @NotNull WearableBonusProvider.SetSlotBuilder addTag(@NotNull TagKey<Item> tagKey) {
