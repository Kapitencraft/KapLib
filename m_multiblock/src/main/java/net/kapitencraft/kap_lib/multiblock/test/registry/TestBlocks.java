...
import net.kapitencraft.kap_lib.multiblock.test.multiblock.*;
...
public interface TestBlocks {
    ...
    DeferredBlock<Mp2CubedEntityBlockTest> MP_2_CUBED_TEST = registerBlock("mp_2_cubed_test", Mp2CubedEntityBlockTest::new);
