...
public class BaseAttributeLocations {
    ...
    public static final ResourceLocation CRIT_CHANCE = LibConstants.res("base_crit_chance");
    public static final ResourceLocation FEROCITY = LibConstants.res("base_ferocity");
    public static final ResourceLocation MAGIC_DAMAGE = LibConstants.res("base_ability_damage");
    public static final ResourceLocation RANGED_DAMAGE = LibConstants.res("base_ranged_damage");
    public static final ResourceLocation DRAW_SPEED = LibConstants.res("base_draw_speed");
    ...
    public static final ResourceLocation WISDOM = LibConstants.res("base_wisdom");
}
