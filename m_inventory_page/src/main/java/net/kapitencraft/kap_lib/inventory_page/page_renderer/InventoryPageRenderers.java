package net.kapitencraft.kap_lib.inventory_page.page_renderer;
...
import net.kapitencraft.kap_lib.inventory_page.page.crafting.CraftingPageRenderer;
import net.kapitencraft.kap_lib.inventory_page.page.equipment.EquipmentPageRenderer;
...
public class InventoryPageRenderers {
    ...
    public static <P extends InventoryPage> PageRenderConstructor<P> getRenderer(P page) {
        return Objects.requireNonNull((PageRenderConstructor<P>) renderers.get(page.getType()), "no renderer for inventory page: '" + InventoryPageRegistries.INVENTORY_PAGES.getKey(page.getType()) + "'");
    }
    ...
    public static <P extends InventoryPage> void register(InventoryPageType<P> type, PageRenderConstructor<P> renderer) {
        if (renderers.put(type, renderer) != null) {
            throw new IllegalArgumentException("duplicate inventory page renderer registration: " + InventoryPageRegistries.INVENTORY_PAGES.getKey(type));
        }
    }
