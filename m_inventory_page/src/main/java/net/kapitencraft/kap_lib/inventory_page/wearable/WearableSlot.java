...
public class WearableSlot {
    public static final StreamCodec<RegistryFriendlyByteBuf, WearableSlot> STREAM_CODEC = ByteBufCodecs.registry(InventoryPageRegistries.Keys.WEARABLE_SLOTS);
    ...
    public int getSlotIndex() {
        return InventoryPageRegistries.WEARABLE_SLOTS.getId(this);
    }
